    ...
    public static void main(String[] args)throws Exception{
        ...
        if(args.length != 1){
            ...
            */
            ...
            KeyGenerator generadorDES = KeyGenerator.getInstance("ESTAESLACLAVE");
...
//            FileOutputStream out = new FileOutputStream(args[0]+".cifrado");
            ...
            FileInputStream in = new FileInputStream("D:\\5IV10\\04DES\\patito.txt");
            FileOutputStream out = new FileOutputStream("D:\\5IV10\\04DES\\patitoCifrado.txt");
...
//            out = new FileOutputStream(args[0]+".descifrado");           
            in = new FileInputStream("D:\\5IV10\\04DES\\patitoCifrado.txt");
            out = new FileOutputStream("D:\\5IV10\\04DES\\patitoDecifrado.txt");
